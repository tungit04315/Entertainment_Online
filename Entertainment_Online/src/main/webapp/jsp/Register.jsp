		...
		<div class="container">
			...
			<div class="container_form">
				...
				<div class="slider_form">
					<form class="form" action="/Entertainment_Online/Register"
						method="post">
						<i class="fa-solid fa-clapperboard"></i> <span class="title">Đăng
							Ký</span>
						<div class="form_control">
							<input required="" name="id" class="input" type="text"> <label
								class="label">Tên Đăng Nhập</label>

						</div>

						<div class="form_control">
							<input required="" name="passwords" class="input" type="password">
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="admins"
								...
								class="form-check-label" for="inlineRadio1">Admin</label> <input
								class="form-check-input" type="radio" name="admins"
								id="inlineRadio2" value="0"> <label
								class="form-check-label" for="inlineRadio2">User</label>
						</div>
						<button class="btn_ok" type="submit">Đăng Ký</button>

						<span class="bottom_text">Bạn đã có tài khoản? <a
							class="swtich" href="./LoginServlet">Đăng Nhập</a>
						</span>
					</form>
				</div>
			</div>
