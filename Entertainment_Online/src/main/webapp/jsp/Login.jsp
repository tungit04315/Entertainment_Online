		...
		<div class="container">
			...
			<div class="container_form">
				...
				<div class="slider_form">
					<form class="form"
						action="/Entertainment_Online/LoginServlet" method="post">
						<i class="fa-solid fa-clapperboard"></i> <span class="title">Đăng
							Nhập</span>
						<div class="form_control">
							<input name="username" required="" class="input" type="text">
							<label class="label">Tên Đăng Nhập</label>
						</div>
						<div class="form_control">
							<input name="password" required="" class="input" type="password">
							<label class="label">Mật Khẩu</label>
						</div>
						<div class="form_control form_control2">
							<a class="text-white" href="./ForgotPassword">Quên Mật Khẩu?</a>
						</div>
						<button class="btn_ok" type="submit">Đăng Nhập</button>

						<span class="bottom_text">Bạn chưa có tài khoản? 
						<a class="swtich" href="./Register">Đăng Ký</a>
						</span>
					</form>
				</div>
			</div>
