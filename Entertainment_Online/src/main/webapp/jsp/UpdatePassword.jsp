		...
		<div class="container">
			...
			<div class="container_form">
                ...
                <div class="slider_form">
                    <form class="form" action="/Entertainment_Online/UpdatePassword" method="post">
                        <i class="fa-solid fa-clapperboard"></i>
                        <span class="title">Đổi Mật Khẩu</span>
                        <div class="form_control">
                            <input required="" name="id" value="${item.id}" class="input" type="text" >
                            <label class="label">Tên Đăng Nhập</label> 
                        </div>
                        <div class="form_control">
                            <input required="" name="password" value="${item.passwords}" class="input" type="password">
                            <label class="label">Mật Khẩu Hiện Tại</label>
                        </div>
                        <div class="form_control">
                            <input required="" name="newPassword" class="input" type="password">
                            <label class="label">Mật Khẩu Mới</label>
                        </div>
                        <div class="form_control">
                            <input required="" name="confirmNewPassword" class="input" type="password">
                            <label class="label">Xác Nhận Mật Khẩu Mới</label>
                        </div>
                        <button class="btn_ok" type="submit">Cập Nhật</button>
                    </form>
                </div>
            </div>
		</div>
