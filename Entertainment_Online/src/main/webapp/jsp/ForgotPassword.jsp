		...
		<div class="container">
			...
			<div class="container_form">
                ...
                <div class="slider_form">
                    <form class="form" action="/Entertainment_Online/ForgotPassword" method="post">
                        <i class="fa-solid fa-clapperboard"></i>
                        <span class="title">Quên Mật Khẩu</span>
                        <div class="form_control">
                            <input required="" name="id" class="input" type="text">
                        ...
                        <span class="bottom_text">Bạn chưa có tài khoản? <a href="./Register">Đăng Ký</a></span>
                    </form>
                </div>
            </div>
